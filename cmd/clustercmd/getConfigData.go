...
func getClusterDetails(region string, crossAccountRoleArn string,accessKey string, secretKey string, clusterName string, env string, externalId string) *eks.DescribeClusterOutput {
